    ...
    <div className="w-5/12">
      <div className="justify-center mt-20">
        ...
        <div className="flex gap-2">
          <span className="flex ">
             Linkedin Profile: <a className="text-blue-500" href="https://www.linkedin.com/in/ykarakaya/" target="_blank"><Image src='/assets/linkedin.png' alt="Yusuf Karakaya linkedin" width={25} height={25} /></a>
          </span>
          <br />
          <span className="flex">
            Github Profile: <a className="text-blue-500" href="https://github.com/yusufkarakaya" target="_blank"><Image src='/assets/github.png' alt="Yusuf Karakaya github" width={25} height={25} /></a>
          </span>
        </div>
        <div>
          <h2 className="mt-5"><strong>Blog</strong></h2>
          <p>A Personal Journey: <a className="text-blue-500" href="https://www.rooneypartners.com/embracing-the-power-of-learning-a-personal-journey/" target="_blank">link</a></p>
          </div>
      </div>
    </div>  
  </main>
